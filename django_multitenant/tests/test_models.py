...
#         list(projects_per_manager)
    ...
    def test_many_to_many_through_saves(self):
        ...
        manager = Manager( name="test save fr")
        manager.save()
        manager2 = Manager( name="test save fr2")
        manager2.save()
        
        
        project.managers.add(manager)
        project.managers.add(manager2)
        
        control_manager = Manager.objects.get(pk=manager.pk)
        assert control_manager.account_id == account.id
        
        control_manager2 = Manager.objects.get(pk=manager2.pk)
        assert control_manager2.account_id == account.id
